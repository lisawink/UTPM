...
energy_base=(policy_results['base']['elec_demand']+policy_results['base']['foss_demand']+policy_results['base']['wtt_energy']+policy_results['base']['ev_prod_energy']+policy_results['base']['ice_prod_energy']+policy_results['base']['conv_prod_energy'])/10**9
...
energy_d81_18=(policy_results['d8181_18']['elec_demand']+policy_results['d8181_18']['foss_demand']+policy_results['d8181_18']['wtt_energy']+policy_results['d8181_18']['ev_prod_energy']+policy_results['d8181_18']['ice_prod_energy']+policy_results['d8181_18']['conv_prod_energy'])/10**9
...
axs[0].plot(range(2020,2051),emiss_ren.dropna(),label="BEVs Powered by 100%\nRenewable Energy",linewidth=2,color=sns.color_palette("Paired")[8])
axs[0].plot(range(2020,2051),emiss_p25.dropna(),label='2025 Phase-Out',linewidth=2, color=sns.color_palette("Paired")[4])
...
axs[0].plot([2020,2030,2050],[3.7,3.7*0.3,0],label='1.5 degree lifestyles target',linewidth=2,color='grey',ls='--')
axs[0].plot([2020,2030,2050],[3.7,3.7*0.55,0],label='IPCC target',linewidth=2,color='black',ls='--')
...
axs[0].set_ylim(0,)
axs[0].legend(bbox_to_anchor=(2.9,0.8))
...
axs[1].plot(range(2020,2051),energy_p25.dropna(),label='2025 Phase-Out',linewidth=2, color=sns.color_palette("Paired")[4])
axs[1].plot(range(2020,2051),energy_early.dropna(),label="Early Scrapping",linewidth=2,color=sns.color_palette("Paired")[11])
axs[1].plot(range(2020,2051),energy_lw40.dropna(),label='Lightweighting to 800kg',linewidth=2,color=sns.color_palette("Paired")[5])
...
plt.savefig('Fig3_en.png', bbox_inches="tight")
plt.savefig('Fig3_en.pdf', bbox_inches="tight")
plt.show()