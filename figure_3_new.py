...
axs[0].plot([2020,2030,2050],[3.7,3.7*0.55,0],label='IPCC 2030 Target',linewidth=2,color='black',ls='--')
axs[0].plot([2020,2050],[-1,-1],label='2050 Energy Budget\nMillward-Hopkins et al.',linewidth=2,color='blue',ls='--')
...
axs[1].plot([2020,2050],[57,8],label='Millward-Hopkins et al.',linewidth=2,color='blue',ls='--')
